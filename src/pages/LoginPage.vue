  ...
  <div class="login-container">
    <div class="login-card">
      ...
      <form v-if="!showSignup" @submit.prevent="handleSubmit" class="login-form">
        <InputFieldAtom v-model="email" label="Email" place-holder="Enter your email" :error-message="errors.email"
          type="email" />

        <InputFieldAtom v-model="password" label="Password" place-holder="Enter your password"
          :error-message="errors.password" type="password" />

        <div v-if="authStore.error" class="error-alert">
          {{ authStore.error }}
        </div>

        <ButtonAtom label="Sign In" variant="primary" type="submit" />
      ...
      <form v-if="showSignup" @submit.prevent="handleSignup" class="login-form">
        ...
        <InputFieldAtom v-model="signupEmail" label="Email" place-holder="Enter your email"
          :error-message="errors.signupEmail" type="email" />

        <InputFieldAtom v-model="signupPassword" label="Password" place-holder="Create a password"
          :error-message="errors.signupPassword" type="password" />

        <InputFieldAtom v-model="confirmPassword" label="Confirm Password" place-holder="Confirm your password"
          :error-message="errors.confirmPassword" type="password" />
